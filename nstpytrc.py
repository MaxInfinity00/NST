##Only able to style transfer aong images of same dimensions :(
...
loader = transforms.Compose([
    transforms.Resize(size=(imsize)),  # scale imported image
...
#Importing the Model and Image Normalization
...
save_image(output, 'picsdanc.png')
